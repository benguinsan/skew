-- biasly / Skew News — pgvector upgrade for existing projects (AGENTS §20)
-- Run in Supabase Dashboard → SQL Editor after enabling the vector extension
-- (Database → Extensions → vector), or rely on the CREATE EXTENSION below.
...
-- IVFFlat cosine index. lists=100 suits growing corpora; fine on small tables too.
